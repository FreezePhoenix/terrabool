...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("worker_wasm.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("worker_wasm.wasm", import.meta.url).href;
}
...
var _malloc, ___getTypeName, _free;

function assignWasmExports(wasmExports) {
  _malloc = wasmExports["C"];
  ___getTypeName = wasmExports["D"];
  _free = wasmExports["E"];
}

var wasmImports = {
  /** @export */ m: ___cxa_throw,
  /** @export */ y: __abort_js,
  /** @export */ x: __embind_finalize_value_array,
  /** @export */ l: __embind_register_bigint,
  /** @export */ w: __embind_register_bool,
  /** @export */ v: __embind_register_emval,
  /** @export */ k: __embind_register_float,
  /** @export */ u: __embind_register_function,
  /** @export */ b: __embind_register_integer,
  /** @export */ a: __embind_register_memory_view,
  /** @export */ t: __embind_register_std_string,
  /** @export */ g: __embind_register_std_wstring,
  /** @export */ s: __embind_register_value_array,
  ...
  /** @export */ i: __emval_get_property,
  /** @export */ h: __emval_incref,
  /** @export */ e: __emval_invoke,
  /** @export */ q: __emval_new_array,
  /** @export */ p: __emval_new_array_from_memory_view,
  /** @export */ o: __emval_new_cstring,
  /** @export */ d: __emval_run_destructors,
