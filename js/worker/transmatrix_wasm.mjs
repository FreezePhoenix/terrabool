...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("transmatrix_wasm.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("transmatrix_wasm.wasm", import.meta.url).href;
}
...
function assignWasmExports(wasmExports) {
  ___getTypeName = wasmExports["C"];
  _malloc = wasmExports["D"];
  _free = wasmExports["E"];
}
